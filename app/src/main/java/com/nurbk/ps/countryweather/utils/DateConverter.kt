...
class DateConverter {
    private var irYear // Year part of a Iranian date
            = 0
    private var irMonth // Month part of a Iranian date
            = 0
    private var irDay // Day part of a Iranian date
            = 0
    ...
    private var JDN // Julian Day Number
            = 0
    private var march // The march day of Farvardin the first (First day of
            = 0
     ...
     * @param day   int
     */
    fun DateConverter(year: Int, month: Int, day: Int) {
